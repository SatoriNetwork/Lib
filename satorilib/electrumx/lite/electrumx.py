...
import queue
import threading
from satorilib.electrumx import ElectrumxLiteConnection
from satorilib.electrumx import ElectrumxLiteApi


class ElectrumxLite(ElectrumxLiteConnection):
    def __init__(
        self,
        *args,
        address: str = '',
